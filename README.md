...
[![CI](https://github.com/protonv11/vaultstream/actions/workflows/ci.yml/badge.svg)](https://github.com/protonv11/vaultstream/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/protonv11/vaultstream.git
cd Flowpoint
...
Full commit history: [View on GitHub ↗](https://github.com/protonv11/vaultstream/commits/main)
